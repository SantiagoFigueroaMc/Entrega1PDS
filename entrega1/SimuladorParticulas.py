...
def Drag(v_relativa,magnitud_v_relativa,coeficiente_de_arrastre,var): #todos los datos que se le pasan son datos cuando se esta en t-1
  #print(x)
  #print(coeficiente_de_arrastre)
  #print(v_relativa)
  #print(magnitud_v_relativa)
...
def SimularParticula(particula_simulada,constante,const):
  #indice_particula = 0 <<< Se va a otro lado
  #particula_simulada = lista_de_particulas[indice_particula] # TODO: Cambiar 0 por indice <<< Se va a otro lado
